...
function render() {
  ...
  // Add an event listener to the reCAPTCHA checkbox
  document.querySelector('[data-netlify-recaptcha="true"]').addEventListener("change", function () {
    if (grecaptcha.getResponse() !== "") {
      enableSubmitButton(); // Enable the submit button when reCAPTCHA is checked
    } else {
      disableSubmitButton(); // Disable the submit button when reCAPTCHA is unchecked
    }
  });
